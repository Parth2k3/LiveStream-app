...
app = Flask(__name__)
CORS(app)
app.config["MONGO_URI"] = "mongodb+srv://simplysimpletricks:i3ATOA9D7IZ2bNxr@live-stream-app.11bfh.mongodb.net/livestream-db?retryWrites=true&w=majority"
mongo = PyMongo(app)
# MongoDB Collection
overlay_collection = mongo.db['livestream-collection']


# Directory to save the HLS files
HLS_DIR = 'static/hls'
path = "C:/ffmpeg/ffmpeg-2024-10-02-git-358fdf3083-full_build/bin/ffmpeg.exe"
